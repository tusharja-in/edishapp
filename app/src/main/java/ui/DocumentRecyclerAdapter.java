...
public class DocumentRecyclerAdapter extends RecyclerView.Adapter<DocumentRecyclerAdapter.ViewHolder>{
    ...
    public DocumentRecyclerAdapter(Context context, List<Document> journalList) {
    ...
    @NonNull
    @Override
    public DocumentRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.document_row, viewGroup, false);

        return new ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull DocumentRecyclerAdapter.ViewHolder viewHolder, int position) {

        Document journal = journalList.get(position);
        String imageUrl;
