...
public class DocumentView extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DocumentApi.getInstance() != null) {
            currentUserId = DocumentApi.getInstance().getUserId();
            //currentUserName = DocumentApi.getInstance().getUsername();
        ...
        if (!TextUtils.isEmpty(title) &&
            ...
            filepath.putFile(imageUri)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //Todo: create a Doc Object - model
                                    Document document = new Document();
                                    document.setTitle(title);
                                    document.setThought(thoughts);
                                    document.setImageUrl(imageUrl);
                                    document.setTimeAdded(new Timestamp(new Date()));
                                    document.setUserName(currentUserName);
                                    ...
                                    collectionReference.add(document)
                                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                ...
                                                public void onSuccess(DocumentReference documentReference) {
                                                    ...
                                                    progressBar.setVisibility(View.INVISIBLE);
                                                    startActivity(new Intent(DocumentView.this,
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(DocumentView.this,"doc saved successfully",Toast.LENGTH_LONG).show();
                            Log.e("errorr",currentUserId);
